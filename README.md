# Скрипт для тестирования интернет-соединения (Provider-Tester)
...
Тест в своей работе подключается к реальным сайтам в подсетях указанных хостингов. Если вы считаете что тестовый сайт не работает (а такое может быть), или он не соответствует подсети - замените самостоятельно его в блоке `# --- Настройки тестов ---`
